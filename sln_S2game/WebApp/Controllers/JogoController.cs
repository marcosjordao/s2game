...
namespace WebApp.Controllers
{
    ...
    public class JogoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DataDeCompra,Ativo")] Jogo jogo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,DataDeCompra,Ativo")] Jogo jogo)
        {
            if (id != jogo.Id)
            {
                return NotFound();
